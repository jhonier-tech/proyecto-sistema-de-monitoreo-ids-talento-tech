@echo off
echo ===================================
echo    Prueba Simple de Captura de Ping (ICMP)
echo ===================================
echo.
...
echo.
echo Esta es una version simplificada de la prueba de captura de paquetes ICMP.
echo Se usara para verificar la compatibilidad con WinPcap.
echo.
...
echo.
echo [2/3] Ejecutando prueba simple de captura ICMP...
echo.
echo IMPORTANTE:
...
REM Ejecutar el script de prueba simple
python tools\test_ping_simple.py
...
echo   ✓ Npcap esta correctamente configurado con compatibilidad WinPcap
echo.
echo Si NO ha visto esos mensajes:
echo   ✗ Posibles problemas:
echo     - Npcap no esta configurado correctamente en modo compatible con WinPcap
...
echo Pasos a seguir:
echo 1. Ejecute solucionar_winpcap.bat para una solucion guiada completa
echo 2. Siga las instrucciones para reinstalar Npcap con compatibilidad WinPcap
echo.
